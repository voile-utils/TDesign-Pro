...
const bucketModules = import.meta.globEager('./modules/**/bucket.ts');

// 导入modules非homepage相关固定路由
const fixedModules = import.meta.globEager('./modules/**/![homepage, bucket].ts');
...
// 存放固定路由
export const bucketRouterList: Array<RouteRecordRaw> = mapModuleRouterList(bucketModules);
